...
$sourcePath = Join-Path -Path $rootDirectory -ChildPath 'ServerSweep\src\Core\Shared'
$destinationPath = Join-Path -Path $rootDirectory -ChildPath 'ClientSweep\src\Shared'
